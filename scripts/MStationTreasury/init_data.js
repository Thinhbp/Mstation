...
async function main() {
    ...
    const MStationTreasury = await hre.ethers.getContractFactory("MStationTreasury");

    const mstationNFT = await MStationTreasury.attach("0x31c56234ddb209ea13519396F71301859c98E5D3");//prod


    const ow  = await mstationNFT.pause();
    console.log(ow);
